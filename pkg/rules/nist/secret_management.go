...
func (r *SecretManagementRule) Check(ctx context.Context, client interface{}, config *types.Config) ([]types.Finding, error) {
	...
	secrets, err := k8sClient.GetSecrets(ctx, config.Namespace)
	if err != nil {
